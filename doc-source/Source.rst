...
.. code-block:: bash
    ...
    $ git clone https://github.com/domdfcoding/seed_intersphinx_mapping"
...
The recommended way to build ``seed_intersphinx_mapping`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
